# Vertical excellence specs

**Status:** canonical research + product spec (2026-06-03)  
**Purpose:** What it takes for each vertical to feel *complete* — operator logs in and says “this is my business,” guest books and says “this studio gets it.”  
**Authority chain:** Program doc (L0–L8 status) → **this folder (L9–L15 vision)** → engineering tickets.

| Vertical | Excellence spec | Program doc |
|----------|-----------------|-------------|
...
**When to update:** Any vertical program gap closure → update both program § changelog and excellence § implementation status.
