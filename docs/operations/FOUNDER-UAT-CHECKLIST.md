...
| 2 | Owner home → **Policy evolution** accept (demo) | | On `luxe-salon-spa`, `bloom-beauty-dublin`, or `harbour-wellness-cork` — accept trusted-client tier |
| 3 | `/settings?tab=booking-rules#emergent-trust` | | Status reflects accept; card-on-file shows as planned |
...
| 10 | Customer profile → **Trusted** toggle | | Disabled until emergent trust enabled |
