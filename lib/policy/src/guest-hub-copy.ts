...
export const GUEST_HUB_COPY = {
  ...
  vaultSubtitle: "Manage visits, message teams, and rebook — without hunting old texts",
  ...
  manageStudioCta: "Your relationship",
  signOutCta: "Sign out",
  livStripTitle: "Liv",
  livStripBody:
  ...
  sidebarWebHint:
    "You're on the web app. On your phone, open the Livia app for the native My Livia experience.",
