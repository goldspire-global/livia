...
export const EventType = {
  ...
  ONBOARDING_ACT_COMPLETED: "ONBOARDING_ACT_COMPLETED",
  ONBOARDING_GO_LIVE_BLOCKED: "ONBOARDING_GO_LIVE_BLOCKED",
  BUSINESS_ACTIVATED: "BUSINESS_ACTIVATED",
  REVIEW_RECEIVED: "REVIEW_RECEIVED",
  PORTFOLIO_ITEM_ATTACHED: "PORTFOLIO_ITEM_ATTACHED",
  PRESENTATION_PRESET_CHANGED: "PRESENTATION_PRESET_CHANGED",
  CAPABILITY_STATE_CHANGED: "CAPABILITY_STATE_CHANGED",
  COMMERCE_SIGNAL_DETECTED: "COMMERCE_SIGNAL_DETECTED",
  TWIN_OBSERVATION_GENERATED: "TWIN_OBSERVATION_GENERATED",
  TWIN_INSIGHT_GENERATED: "TWIN_INSIGHT_GENERATED",
  TWIN_RISK_DETECTED: "TWIN_RISK_DETECTED",
  TWIN_OPPORTUNITY_DETECTED: "TWIN_OPPORTUNITY_DETECTED",
} as const;
