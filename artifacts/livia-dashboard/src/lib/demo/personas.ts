...
export const PERSONAS: Persona[] = [
  ...
  },
  {
    ...
    roleLabel: "Guest · My Livia",
    businessName: "Demo guest across showcase studios",
    accent: "rose",
    iconName: "Heart",
    tease: "Manage visits, rebook, and message studios — the guest side of Livia.",
    welcomeLine: "Your next visit is coming up, Mary.",
    welcomeSub: "Everything you've booked lives here — no business login.",
    ritualLine: "One phone sign-in. Every studio you've used.",
    alertText: "Bloom Beauty sent a reminder for your manicure on Saturday.",
    alertKind: "human",
    nativeMomentTitle: "My Livia · visit ready",
    nativeMomentBody: "Tap to manage your visit, message the team, or book again.",
    nativeMomentKind: "live-activity",
  },
];
