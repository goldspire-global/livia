...
const W4_MAP = [
  ...
  ["editorial", "w4-beauty-editorial-layout-menu-cards-home.sample.png", "dashboard-owner-solo.target.png"],
  ["editorial", "w4-beauty-editorial-inbox-owner.sample.png", "inbox-owner.target.png"],
  ...
  ["premium-dark", "w4-beauty-premium-dark-layout-glow-cards-home.sample.png", "dashboard-owner-solo.target.png"],
  ["premium-dark", "w4-beauty-premium-dark-inbox-owner.sample.png", "inbox-owner.target.png"],
  ["premium-dark", "w4-beauty-premium-dark-manager-cockpit.sample.png", "dashboard-manager.target.png"],
