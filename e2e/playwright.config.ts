...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      name: "dashboard",
      testMatch:
        /(dashboard-gate|eu-owner-self-onboard|prod-onboarding-notifications|demo-owner-flow|visual-screen-p0|preset-public-parity|bloom-beauty-public|gateway-beauty-wedge|wellness-room-board|wellness-announcement-smoke|migration-import-path|onboarding-fast-track|onboarding-navigation-resilience|founder-onboarding-resume|route-audit-cross-surface)\.spec\.ts/,
    ...
    {
      name: "pls-wave3",
      testMatch: /pls-wave3-capture\.spec\.ts/,
      timeout: 780_000,
      workers: 1,
      use: {
        ...devices["Desktop Chrome"],
